...
public class LinkedListTabulatedFunction implements TabulatedFunction, Externalizable, Cloneable {
    ...
    public boolean equals(Object o) {
        ...
        if (o instanceof LinkedListTabulatedFunction) {
            ...
            FunctionNode c1 = this.head.next;
            FunctionNode c2 = that.head.next;

            while (c1 != this.head && c2 != that.head) {
                double x1 = c1.point.getX();
                double y1 = c1.point.getY();
                double x2 = c2.point.getX();
            ...
            return c1 == this.head && c2 == that.head;
        } else {
